# -*- coding: utf-8 -*-
# 20180628 15:14
# 测试CPU在不同batch_size及不同CPU核心下的计算性能
...
log_dir = os.path.join(os.getcwd(), '1_ship_losangeles/')
...
cpu_num = int(os.environ.get('CPU_NUM', 40))  # 通过修改CPU_NUM 的数值可以控制使用的CPU核心数
...
with tf.Session(config=config1) as sess:
    ...
    for i in xrange(20):
        ...
        print ("CPU_NUM", cpu_num,
               ...
               " total_time is ", (time.time()-start_time)/num_loop)
    coord.request_stop()
    coord.join(threads)
