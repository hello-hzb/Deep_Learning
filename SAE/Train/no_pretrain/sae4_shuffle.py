...
from Autoencoder import SAEnoplh, SAEnoplhdevice, SAEnoplhV2, SAEnoplhV4
...
with tf.device("/cpu:0"):
    ...
    image = tf.train.shuffle_batch([input_image],
...
# cpu: 37.84      gpu:21.05    gpuv2 15.00   cpuv2 37.93
