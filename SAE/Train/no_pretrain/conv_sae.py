...
# auc=0.77
# hidden_size = [166, 83, 32, 83, 166]  # 各个隐藏层的节点数
# kernel_size = [5, 5, 5, 5, 5]
# output_kernel_size = 5

# auc=0.823
# stack_size = 5  # 自编码器的隐藏层层数
# hidden_size = [166, 83, 32, 83, 166]  # 各个隐藏层的节点数
# kernel_size = [kk_size, kk_size, kk_size, kk_size, kk_size]
...
class Modelconfig(object):
    ...
    training_epochs = 2                                        # 训练的轮数
    batch_size = 10000                                              # 更新一次参数训练的样本数
    display_step = 1                                              # 打印信息的步数
    stack_size = 1                                                # 自编码器的隐藏层层数
    hidden_size = [20, 83, 32, 83, 166]                                  # 各个隐藏层的节点数
...
# image = tf.placeholder(tf.float32, [10, 10, 126])
